...
function TaskclusterContainer(platform, arch, spec) {
    this.namespace = spec.arches[arch].namespace;
    this.path = spec.arches[arch].path;
    this.fileEnding = spec.arches[arch].fileEnding;
}
